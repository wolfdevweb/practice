...
3. Сайт должен загружаться в браузере не дольше 1 секунды (1 секунда это максимум), то есть сам html + css + javascript должны давать загрузку сайта менее 1 секунды. 
...
5. Пункты меню сайта должны соответсвовать
